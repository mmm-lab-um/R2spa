...
Because the latent constructs have no intrinsic scale, the **standardized**
coefficients are usually the parameters of substantive interest (see the
*Two-Stage Path Analysis* vignette, `vignette("R2spa")`, for the reasoning and
references):
