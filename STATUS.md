...
re-integration (`vcov_corrected()`, `get_fs_int()` — `tspa_mx()` re-integrated in
...
- Grand-standardized-solution re-integration verification (2026-08-22, branch
  ...
  **3378 pass / 0 fail / 0 skip** (3358 at the parent; the delta is exactly the
